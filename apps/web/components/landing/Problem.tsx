...
const stats = [
  {
    number: "10×",
    label: "Dengue surge",
    detail: "Cases in Nepal multiplied 10× between 2010 and 2024.",
  ...
  },
  {
    number: "2–4 wk",
    label: "Detection lag",
    detail: "Paper-based surveillance means outbreaks are found weeks too late.",
  ...
  },
  {
    ...
    detail: "Under-15s account for 40% of severe dengue cases.",
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl lg:text-5xl font-black text-white mb-6 max-w-3xl leading-tight">
            Climate change is{" "}
            <span className="gradient-text">moving disease</span> into new communities.
          </h2>
          <p className="text-lg text-white/50 max-w-2xl leading-relaxed">
            Warming temperatures and shifting monsoon patterns are creating new mosquito
            breeding grounds in Nepal&apos;s mid-hill districts — areas that were
            effectively mosquito-free a decade ago. By the time outbreaks are detected,
          ...
          <div className="p-8 rounded-2xl bg-white/5 border border-white/10">
            ...
            <ul className="space-y-3">
              {[
                ...
                "Spray teams walk neighborhoods — find ~30% of habitats",
                "Blanket chemical application regardless of confirmation",
          ...
          <div className="p-8 rounded-2xl bg-[#f59e0b]/5 border border-[#f59e0b]/20">
            ...
            <ul className="space-y-3">
              {[
                ...
                "Precision spray at confirmed sites only",
                "4–6 week outbreak prediction from fused data",
              ].map((item) => (
