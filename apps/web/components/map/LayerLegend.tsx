...
export function LayerLegend() {
  return (
    <div className="absolute bottom-8 right-4 z-10 bg-white/95 backdrop-blur rounded-xl border border-[#e5e7eb] shadow-md p-4 text-sm min-w-[200px]">
      <div className="font-semibold text-[#1e3a5f] mb-3 text-xs uppercase tracking-wide">Legend</div>
